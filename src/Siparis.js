  ...
  useEffect(() => { //sayfa açılır açılmaz çalışır bu kodlar
    ...
    const getAllOrderInfo = async () => {
        let response = await axios.get(
            'https://private-d0072-aycanursenakorkmaz.apiary-mock.com/Siparis'
            );
    
            console.log("getAllUserInfo" + response.data.SiparisListesi);

            setAllOrder(response.data.SiparisListesi);
              ...
              <div className="portlet-body">
                <div className="table-responsive">
                  <table className="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                      {
                      allOrder.map( (data) => (  //foreach gibi, data yerin index'te yazabilirsin
                      <> 
                        <tr>
