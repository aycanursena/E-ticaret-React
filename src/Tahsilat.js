  ...
  useEffect(() => { //sayfa açılır açılmaz çalışır bu kodlar
    ...
    const getAllCollectionInfo = async () => {
        let response = await axios.get(
            ...
            console.log("getAllUserInfo" + response.data.TahsilatListesi);

            setAllCollection(response.data.TahsilatListesi);
              ...
              <div className="portlet-body">
                <div className="table-responsive">
                  <table className="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                    {
                      allCollection.map( (data) => (  //foreach gibi, data yerin index'te yazabilirsin
                      <> 
                      <tr>
                        <td>{data.TahsilatId}</td>
                        <td>{data.Müsteri}</td>
                        <td>{data.Tutar}</td>
