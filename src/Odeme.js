  ...
  useEffect(() => { //sayfa açılır açılmaz çalışır bu kodlar
    ...
    const getAllPaymentInfo = async () => {
        let response = await axios.get(
            ...
            console.log("getAllUserInfo" + response.data.OdemeListesi);

            setAllPayment(response.data.OdemeListesi);
              ...
              <div className="portlet-body">
                <div className="table-responsive">
                  <table className="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                    {
                      allPayment.map( (data) => (  //foreach gibi, data yerin index'te yazabilirsin
                      <> 
                      <tr>
                        <td>{data.OdemeId}</td>
                        <td>{data.Kime}</td>
